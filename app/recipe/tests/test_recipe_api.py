...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='user2@exmaple.com', password='sample123')
        recipe = create_recipe(user=self.user)
    ...
    def test_delete_other_users_recipe_error(self):
        """Test deleting other users recipe results in error"""
        new_user = create_user(email='user2@example.com', password='sample123')
    ...
    def test_update_recipe_assign_tag(self):
        """Test updating a recipe by assigning a tag"""
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        self.assertNotIn(ingredient, payload['ingredients'])
        for ingredient in payload['ingredients']:
            exists = recipe.ingredients.filter(
                name=ingredient['name'],
                user=self.user,
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test updating a recipe by assigning an ingredient"""
    ...
    def test_filter_by_ingredients(self):
        ...
        ingredient2 = Ingredient.objects.create(user=self.user, name='Tahini')
